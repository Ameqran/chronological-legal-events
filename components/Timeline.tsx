...
const events: Event[] = [
  ...
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1Cb66uux_hezSSa_Mvf2MaW3zRUbIbGtF/view?usp=drive_link" target="_blank">Cognizant contract signed.pdf</a></i></li></ul>',
    type: 'success',
    category: 'contrato'
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1w4VZX6ro3kIBzlaWB1DxCmofPet_jVV8/view?usp=drive_link" target="_blank">28th April 1st day pickup & receiving laptops.pdf</a></i></li><li><i><a href="https://drive.google.com/file/d/1fdylsplh52TXVkQXFzqGhxieAOP1Jr5s/view?usp=drive_link" target="_blank">29th April 2nd day setup of ING computers.pdf</a></i></li><li><i><a href="https://drive.google.com/file/d/1iNp9VJpjOv6k06eB2BhfbCotBAwh12AB/view?usp=drive_link" target="_blank">30th April 3rd day standby and permit process.pdf</a></i></li><li><i><a href="https://drive.google.com/file/d/1DRCQomgfSqP35QI6UeAAkSvD91Vle4sC/view?usp=drive_link" target="_blank">work permit with Cognizant.pdf</a></i></li></ul>',
    type: 'info',
    category: 'trabajo'
  },
  {
  ...
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/17QmDfJoE2d0cdFARSX9VGAI2jbRlNLtC/view?usp=drive_link" target="_blank">seguridad social sms.jpg</a></i></li></ul>',
    type: 'error',
  ...
  },
  {
    ...
    files: '<ul><li><i>ESCRITO ANULACION ALTA.pdf</i></li><li><i><a href="https://drive.google.com/file/d/1QJ7svKt654UHTZMFqc5gTlrN-UmsAGZO/view?usp=drive_link" target="_blank">Justificante de Presentacion REG.pdf</a></i></li></ul>',
    type: 'error',
  ...
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1MK4hFscuCZCdMfLfTDxO_1lNqrS_w9XR/view?usp=drive_link" target="_blank">16th Mai Approval Marouane.pdf</a></i></li></ul>',
    type: 'success',
    category: 'permiso'
  },
  {
  ...
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1CMbVSxQhRmFI2JjINbz4KJ26v1g15EzH/view?usp=drive_link" target="_blank">Fingerprints appointment.pdf</a></i></li></ul>',
    type: 'warning',
    category: 'permiso'
  },
  {
  ...
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1nTX-XN7kFE5G29WLElNEQNOOVH9PiEhK/view?usp=drive_link" target="_blank">DEMANDA DESPIDO MAROUANE.pdf</a></i></li></ul>',
    type: 'info',
    category: 'legal'
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1dFEx-vW79TM94Xo4zAWb6r4S74XJSf4H/view?usp=drive_link" target="_blank">Justificante de Presentación REG Comunicacion UGE-CE.pdf</a></i></li></ul>',
    type: 'info',
    category: 'permiso'
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1tuKwwwpA3TVFFO0yeVgX8o4WTxQXwmnP/view?usp=drive_link" target="_blank">Captura ("Registro confirmado 11-08-2025").png</a></i></li></ul>',
    type: 'success',
    category: 'permiso'
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1wA8yxHXvs2bFPs_n-ZPU39fFZqO-N3Cs/view?usp=drive_link" target="_blank">justificante solicitude modificacion cuenta ajena y propia.pdf</a></i></li></ul>',
    type: 'info',
    category: 'permiso'
  },
  {
...

  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1Lt1kUxpOSKdM4OyhEHI71SnqGq8Nw9dB/view?usp=drive_link" target="_blank">19th Sep CGI Precontrato.pdf</a></i></li></ul>',
    type: 'success',
    category: 'oferta'
  },
  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1RJO5KLQftKa_ixk9y_U7fsq7Apprh8rO/view?usp=drive_link" target="_blank">6th October CGI Work Permit Invalid.pdf</a></i></li></ul>',
    type: 'error',
    category: 'oferta'
  },

  {
    ...
    files: '<ul><li><i><a href="https://drive.google.com/file/d/1nsYLdVJfIR2UJDRNpsyFSdCpOho1P1Ti/view?usp=drive_link" target="_blank">denegacion cuenta ajena y propia.pdf</a></i></li></ul>',
    type: 'error',
    category: 'permiso'
  },
  {
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-start gap-3 text-sm">
                    ...
                    <div className="w-full">
                      <p className="font-semibold text-gray-700 mb-2">Documentación:</p>
                      <div dangerouslySetInnerHTML={{ __html: event.files }} className="text-gray-600 leading-relaxed" />
                    </div>
                  </div>
                </div>
              )}
